...
---@class dreamwork.std.ModelClass : dreamwork.std.Model
...
do
    ...
    if util_GetActivityIDByName ~= nil then

        std.setmetatable( activity_ids, {
...
local activity_names = std.table.flipped( activity_ids )

do

    local util_GetActivityNameByID = glua_util.GetActivityNameByID

    if util_GetActivityNameByID ~= nil then

        std.setmetatable( activity_names, {
...
function ModelClass.getGlobalActivityID( act_name )
