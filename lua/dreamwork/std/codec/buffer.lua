...
---@class dreamwork.std.buffer
local buffer = std.buffer or {}
std.buffer = buffer
...
---
---@class dreamwork.std.buffer.Reader : dreamwork.std.Object
---@field __class dreamwork.std.buffer.ReaderClass
...
local Reader = class.base( "buffer.Reader" )
...
---
---@class dreamwork.std.buffer.ReaderClass : dreamwork.std.buffer.Reader
---@field __base dreamwork.std.buffer.Reader
---@overload fun(): dreamwork.std.buffer.Reader
...
---
---@class dreamwork.std.buffer.Writer : dreamwork.std.Object
---@field __class dreamwork.std.buffer.WriterClass
---@field protected position integer The current position of the reader in bytes. **READ-ONLY**
---@field protected data_length integer The size of the reader in bytes. **READ-ONLY**
---@field protected data string The content of the reader. **READ-ONLY**
local Writer = class.base( "buffer.Writer" )
...
---
---@class dreamwork.std.buffer.WriterClass : dreamwork.std.buffer.Writer
---@field __base dreamwork.std.buffer.Writer
---@overload fun(): dreamwork.std.buffer.Writer
...
function buffer.readUInt8( binary_str, start_position )
...
---@return nil | string err_msg The error message.
function buffer.readUInt16( binary_str, big_endian, start_position )
...
---@return nil | string err_msg The error message.
function buffer.readUInt24( binary_str, big_endian, start_position )
    if start_position == nil then
        start_position = 1
    end
...
---@return string | nil binary_str The binary string.
---@return nil | string err_msg The error message.
function buffer.writeUInt24( value, big_endian )
...
---@return nil | string err_msg The error message.
function buffer.readUInt32( binary_str, big_endian, start_position )
    if start_position == nil then
        start_position = 1
    end
...
---@return nil | string err_msg The error message.
function buffer.readUInt40( binary_str, big_endian, start_position )
    if start_position == nil then
        start_position = 1
    end
...
---@return string | nil binary_str The binary string.
---@return nil | string err_msg The error message.
function buffer.writeUInt40( value, big_endian )
...
---@return nil | string err_msg The error message.
function buffer.readUInt48( binary_str, big_endian, start_position )
    if start_position == nil then
        start_position = 1
    end
...
---@return string | nil binary_str The binary string.
---@return nil | string err_msg The error message.
function buffer.writeUInt48( value, big_endian )
...
---@return nil | string err_msg The error message.
function buffer.readUInt56( binary_str, big_endian, start_position )
    if start_position == nil then
        start_position = 1
    end
...
---@return string | nil binary_str The binary string.
---@return nil | string err_msg The error message.
function buffer.writeUInt56( value, big_endian )
...
---@return nil | string err_msg The error message.
function buffer.readUInt64( binary_str, big_endian, start_position )
    if start_position == nil then
        start_position = 1
    end
...
do
    ...
    ---@return nil | string err_msg The error message.
    function buffer.readUnsignedFixedPoint( binary_str, m, n, big_endian, start_position )
...
---@return nil | string err_msg The error message.
function buffer.readInt8( binary_str, start_position )
...
---@return nil | string err_msg The error message.
function buffer.readInt16( binary_str, big_endian, start_position )
    if start_position == nil then
        start_position = 1
    end
...
---@return nil | string err_msg The error message.
function buffer.readInt24( binary_str, big_endian, start_position )
    if start_position == nil then
        start_position = 1
    end
...
---@return string | nil binary_str The binary string.
---@return nil | string err_msg The error message.
function buffer.writeInt24( value, big_endian )
...
---@return nil | string err_msg The error message.
function buffer.readInt32( binary_str, big_endian, start_position )
    if start_position == nil then
        start_position = 1
    end
...
---@return nil | string err_msg The error message.
function buffer.readInt40( binary_str, big_endian, start_position )
    if start_position == nil then
        start_position = 1
    end
...
---@return string | nil binary_str The binary string.
---@return nil | string err_msg The error message.
function buffer.writeInt40( value, big_endian )
...
---@return nil | string err_msg The error message.
function buffer.readInt48( binary_str, big_endian, start_position )
    if start_position == nil then
        start_position = 1
    end
...
---@return string | nil binary_str The binary string.
---@return nil | string err_msg The error message.
function buffer.writeInt48( value, big_endian )
...
---@return nil | string err_msg The error message.
function buffer.readInt56( binary_str, big_endian, start_position )
    if start_position == nil then
        start_position = 1
    end
...
---@return string | nil binary_str The binary string.
---@return nil | string err_msg The error message.
function buffer.writeInt56( value, big_endian )
...
---@return nil | string err_msg The error message.
function buffer.readInt64( binary_str, big_endian, start_position )
    if start_position == nil then
        start_position = 1
    end
...
do
    ...
    ---@return nil | string err_msg The error message.
    function buffer.readFixedPoint( binary_str, m, n, big_endian, start_position )
        local byte_count = (m + n) * 0.125
        if byte_count % 1 ~= 0 then
            return nil, "invalid m.n values"
        end
...
do
    ...
    ---@return nil | string err_msg The error message.
    function buffer.readFloat( binary_str, big_endian, start_position )
        if start_position == nil then
            start_position = 1
        end
...
do
    ...
    ---@return nil | string err_msg The error message.
    function buffer.readDouble( binary_str, big_endian, start_position )
        if start_position == nil then
            start_position = 1
        end
...
do
    ...
    ---@return nil | string err_msg The error message.
    function buffer.readDate( binary_str, big_endian, start_position )
        if start_position == nil then
            start_position = 1
        end
...
do
    ...
    ---@return nil | string err_msg The error message.
    function buffer.readTime( binary_str, big_endian, start_position )
        if start_position == nil then
            start_position = 1
        end
...
---@return nil | string err_msg The error message.
function buffer.readCountedString( binary_str, byte_count, big_endian, start_position )
...
function buffer.readNullTerminatedString( binary_str, start_position )
    if start_position == nil then
        start_position = 1
    end
...
function buffer.writeNullTerminatedString( str )
    return str .. "\0"
end
...
do
    ...
    do
        ...
        function buffer.serialize( obj, data )
            writer:open()
    ...
    do
        ...
        ---@param data? any The additional data to pass to the deserialization method.
        ---@return dreamwork.std.Object obj The deserialized object.
        function buffer.deserialize( str, value, data )
            reader:open( str )
...
do
    ...
    function buffer.readHex8( hex8_str, start_position )
        if start_position == nil then
            start_position = 1
        end
...
do
    ...
    function buffer.writeHex8( uint8 )
...
do
    ...
    function buffer.readHex16( hex16_str, big_endian, start_position )
        if start_position == nil then
            start_position = 1
        end
...
do
    ...
    function buffer.writeHex16( uint16, big_endian )
...
do
    ...
    function buffer.readHex32( hex32_str, big_endian, start_position )
        if start_position == nil then
            start_position = 1
        end
...
do
    ...
    function buffer.writeHex32( uint32, big_endian )
...
function buffer.readObject( object_class, binary_str, start_position )

end

function buffer.writeObject( obj )
